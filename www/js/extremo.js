...
function onResume() {
  ...
  containerExtremo.style.pointerEvents = 'all'
...
function onPause() {
  ...
  containerExtremo.style.pointerEvents = 'none'
  document.addEventListener("backbutton", onBackKeyDown, false)
...
window.addEventListener('load', () => {
  ...
  for (let i = 0; i < datos.length; i++) {
    ...
    nombre = JSON.stringify(datos[i].nombreExtremo)
    salidat = document.querySelector("#nombreExtremo")
...
const card = document.querySelectorAll('.cell-extremo')
const front = document.querySelectorAll('.front')
const containerExtremo = document.querySelector('.container-memory-extremo')
...
function recordCronometro() {
  nombre = document.querySelector('#nombreExtremo').textContent
