...
function onResume() {
  ...
  containerNormal.style.pointerEvents = 'all'
...
function onPause() {
  ...
  containerNormal.style.pointerEvents = 'none'
  document.addEventListener("backbutton", onBackKeyDown, false)
...
window.addEventListener('load', () => {
  ...
  for (let i = 0; i < datos.length; i++) {
    ...
    nombre = JSON.stringify(datos[i].nombreNormal)
    salidat = document.querySelector("#nombreNormal")
...
const card = document.querySelectorAll('.cell-normal')
const front = document.querySelectorAll('.front')
const containerNormal = document.querySelector('.container-memory-normal')
...
function recordCronometro() {
  nombre = document.querySelector('#nombreNormal').textContent
