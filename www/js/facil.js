...
function onResume() {
  ...
  containerFacil.style.pointerEvents = 'all'
...
function onPause() {
  ...
  containerFacil.style.pointerEvents = 'none'
  document.addEventListener("backbutton", onBackKeyDown, false)
...
window.addEventListener('load', () => {
  ...
  for (let i = 0; i < datos.length; i++) {
    ...
    nombre = JSON.stringify(datos[i].nombreF)
    salidat = document.querySelector("#nombreF")
...
const card = document.querySelectorAll('.cell-facil')
const front = document.querySelectorAll('.front')
const containerFacil = document.querySelector('.container-memory-facil')
...
function recordCronometro() {
  nombre = document.querySelector('#nombreF').textContent
